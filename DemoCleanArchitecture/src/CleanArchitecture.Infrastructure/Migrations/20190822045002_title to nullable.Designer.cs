...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Core.Business", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Core.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Core.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.HR.EmployeeTitle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Messaging.AutoMessageConfigMessageReceiver", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Messaging.AutoMessageConfigMessageReceiverGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Messaging.AutoMessageConfigProvider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Accounts.AppUser", b =>
                {
                    b.HasOne("CleanArchitecture.Core.Entities.Core.Business", "Business")
                        .WithOne("AppUser")
                        .HasForeignKey("CleanArchitecture.Core.Entities.Accounts.AppUser", "BusinessId");

                    b.HasOne("CleanArchitecture.Core.Entities.Core.Person", "Person")
                        .WithOne("AppUser")
                        .HasForeignKey("CleanArchitecture.Core.Entities.Accounts.AppUser", "PersonId");
                });

            modelBuilder.Entity("CleanArchitecture.Core.Entities.Core.Business", b =>
                {
                    b.HasOne("CleanArchitecture.Core.Entities.Core.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CleanArchitecture.Core.Entities.Accounts.AppUser", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById");

                    b.HasOne("CleanArchitecture.Core.Entities.Core.Business", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");

                    b.HasOne("CleanArchitecture.Core.Entities.Accounts.AppUser", "RemovedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Core.Person", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Core.Entities.Core.Person", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.HR.Department", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Core.Entities.HR.Department", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.HR.Employee", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Core.Entities.HR.EmployeeTitle", "EmployeeTitle")
                        .WithMany()
                        .HasForeignKey("EmployeeTitleId");

                    b.HasOne("CleanArchitecture.Core.Entities.HR.Employee", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Messaging.AutoMessageConfig", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Core.Entities.Messaging.AutoMessageConfig", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Messaging.AutoMessageConfigMessageReceiver", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Core.Entities.Messaging.AutoMessageConfigMessageReceiver", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Messaging.AutoMessageConfigMessageReceiverGroup", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Core.Entities.Messaging.AutoMessageConfigMessageReceiverGroup", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Messaging.AutoMessageConfigProvider", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Core.Entities.Messaging.AutoMessageConfigProvider", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Messaging.MessageReceiver", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Core.Entities.Messaging.MessageReceiver", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Messaging.MessageReceiverGroup", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Core.Entities.Messaging.MessageReceiverGroup", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Messaging.MessageReceiverGroupMessageReceiver", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Core.Entities.Messaging.MessageReceiverGroupMessageReceiver", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Messaging.MessageServiceProvider", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Core.Entities.Messaging.MessageServiceProvider", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Messaging.ReceiverCategory", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Core.Entities.Messaging.ReceiverCategory", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Messaging.ReceiverProvider", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Core.Entities.Messaging.ReceiverProvider", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Messaging.SentMessage", b =>
                {
                    b.HasOne("CleanArchitecture.Core.Entities.Messaging.AutoMessageConfig", "AutoMessageDetails")
                        .WithMany()
                        .HasForeignKey("AutoMessageConfigId");
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Sales.Customer", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Core.Entities.Sales.Customer", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");
            ...
            modelBuilder.Entity("CleanArchitecture.Core.Entities.Sales.Distributor", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Core.Entities.Sales.Distributor", "Origin")
                        .WithMany("Versions")
                        .HasForeignKey("OriginId");
