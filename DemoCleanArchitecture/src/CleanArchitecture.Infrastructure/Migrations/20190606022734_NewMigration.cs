    ...
    public partial class NewMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReceiverCategory", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmpoyeeJobs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmpoyeeJobs_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeJobRequirements", x => x.EmployeeJobId);
                    table.UniqueConstraint("AK_EmployeeJobRequirements_JobRequirementId", x => x.JobRequirementId);
                    table.ForeignKey(
                        name: "FK_EmployeeJobRequirements_EmpoyeeJobs_EmployeeJobId",
                        column: x => x.EmployeeJobId,
                        principalTable: "EmpoyeeJobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeJobRequirements_JobRequirements_JobRequirementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmpoyeeJobs_EmployeeId",
                table: "EmpoyeeJobs",
                column: "EmployeeId");
