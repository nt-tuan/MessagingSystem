...
namespace CleanArchitecture.Infrastructure.Data
{
    public class MessageReceiverRepository : IMessageReceiverRepository
    {
        ...
        public Task<MessageReceiver> AddCustomerReceiver(int customerid, int? createdby)
        {
            throw new NotImplementedException();
        }

        public Task<MessageReceiver> AddEmployeeReceiver(int employeeid, int? createdby)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<ReceiverProvider> AddReceiverProvider(int receiverid, int providerid, string address, int? createdby)
        {
            throw new NotImplementedException();
        }
        ...
        public Task DeleteReceiver(int id, int? createdby)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<MessageReceiverGroup> GetGroupById(int id, bool throwException = false)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<MessageReceiver> GetReceiverById(int id, bool throwException)
        {
            throw new NotImplementedException();
        }

        public Task<ICollection<MessageReceiver>> GetReceivers(int? pageCount = null, int? page = null, string search = null, int? groupid = null, int? cateid = null)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<MessageReceiver> UpdateReceiver(int id, MessageReceiver receiver, int? createdby)
        {
            throw new NotImplementedException();
        }
        /*
