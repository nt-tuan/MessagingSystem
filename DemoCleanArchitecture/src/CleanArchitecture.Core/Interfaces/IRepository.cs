...
namespace CleanArchitecture.Core.Interfaces
{
    public interface IRepository
    {
        ...
        Task<T> AddDetail<T>(T entity, DateTime? at = null) where T : BaseDetailEntity<T>;

        //Update
        Task Update<T>(T entity) where T : BaseEntity;
        Task UpdateDetail<T>(T entity, DateTime? at = null) where T : BaseDetailEntity<T>;

        //Delete
        Task Delete<T>(T entity) where T : BaseEntity;
        Task DeleteDetail<T>(T entity, DateTime? at = null) where T : BaseDetailEntity<T>;
    }
}
